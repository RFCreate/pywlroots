...
class Seat(PtrHasData):
    ...
    def touch_send_cancel(self, seat_client: SeatClient) -> None:
        """
    ...
    def touch_notify_cancel(self, seat_client: SeatClient) -> None:
        ...
        lib.wlr_seat_touch_notify_cancel(self._ptr, seat_client._ptr)
